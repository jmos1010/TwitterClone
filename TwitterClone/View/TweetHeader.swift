...
class TweetHeader: UICollectionReusableView {
    ...
    private let dateLabel: UILabel = {
       let label = UILabel()
        ...
        label.text = "11:21 PM - 01/21/2021"
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        let profileImagestack = UIStackView(arrangedSubviews: [profileImageView, labelStack])
        ...
        dateLabel.anchor(top: captionLabel.bottomAnchor, left: leftAnchor, right: rightAnchor,
